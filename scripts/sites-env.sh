...
# Runtime caches must live outside the project. Vinext's compatibility scanner
# recursively examines project source files and intentionally does not treat a
# project-local runtime cache as an ignored dependency directory.
runtime_parent="${TMPDIR:-/tmp}"
runtime_parent="${runtime_parent%/}"
runtime_root="${SITES_RUNTIME_ROOT:-${runtime_parent}/psr-sites-runtime}"
...
export SITES_RUNTIME_ROOT="${runtime_root}"
