...
Map ownership stays with Espacios. PSR map routes remain a cutover concern outside this repo.

The lean `psr-property` app tree is in this repository. `public/` assets and Espacios map data are not.
