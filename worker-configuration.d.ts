/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: 47d54633214a7f3e344edbd9662ac105)
...
interface __BaseEnv_Env {
	...
	GRACE_PUBLIC_AGENT: DurableObjectNamespace<import("./dist/server/index").GracePublicAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./dist/server/index");
		durableNamespaces: "GracePublicAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CAMPAIGN_DELIVERY_ENABLED" | "EMAIL_INBOX_ENABLED" | "EMAIL_SENDING_ENABLED" | "EMAIL_RECEIVE_DOMAIN">> {}
}
